...
class CustomerDemographics(models.Model):
    customer_type_id = models.CharField(primary_key=True)
...
class NorthwindOrder(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class ProductAudit(models.Model):
    ...
    old_price = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    new_price = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class VipCustomers(models.Model):
